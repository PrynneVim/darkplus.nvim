...
theme.set_highlights = function()
  ...
  -- Treesitter
  hl(0, "TSComment", { fg = c.green, bg = 'NONE' })
  ...
  hl(0, "CmpItemKindKeyword", { fg = c.ui_purple2, bg = 'NONE' })
  ...
  hl(0, "CmpItemKindSnippet", { fg = c.ui_orange_yellow, bg = 'NONE' })
  ...
  hl(0, "CmpItemKindCopilot", { fg = c.ui_copilot, bg = 'NONE' })
